...
from pyspark.sql.functions import desc, row_number, dense_rank, col, lit
...
dbutils.widgets.text("SourcePath"         , "/bronze/Internal/Eclipse/Staging"                , "SourcePath")
dbutils.widgets.text("TargetPath"         , "/bronze/Internal/Eclipse/DeltaLake"              , "TargetPath")
...
df = spark.read.json("/mnt/bronze/masterdata/Internal/MDM/Staging/Ref_Country") 
...
df_json = (spark
      ...
      .json("/mnt/bronze/masterdata/Internal/MDM/Staging/Ref_Country") 
      .filter(col("SystemLoadID") > int_watermarkValue) )


df_json1 = df_json.select("SystemLoadID",
    
    explode("data").alias("dataExplode")
).select("dataExplode.*","SystemLoadID")
...
dbutils.widgets.text("TargetPath"         , "/bronze/masterdata/Internal/MDM/DeltaLake"              , "TargetPath")
str_targetDatabaseName = 'MDMBronze'
str_targetTableName = 'Ref_Country'
str_targetTablePath = "/mnt/bronze/masterdata/Internal/MDM/DeltaLake/Ref_Country"
